...
public static void main(String[] args) {
    ...
    System.out.println(StringsNumber(new String[] { "xyz", "x", "y", "z" }, "abc")); // output : 3
    System.out.println(StringsNumber(new String[] { "a", "a", "a", "" }, "ab")); // output : 0
}
public static int StringsNumber(String[] patterns , String word){
//code here
    int count = 0;
    for (String str: patterns){
        if (str != "" && word.contains(str))
        count++;
    }
    return count;
}
