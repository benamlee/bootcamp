...
;
INSERT INTO JOB_GRADES values ('HI', 300, 3000000);
INSERT INTO JOB_GRADES values ('ME', 200, 2000000);
INSERT INTO JOB_GRADES values ('SI', 100, 1000000);
UPDATE JOBS SET GRADE_LEVEL = 'HI' WHERE JOB_TITLE = 'CCC';
UPDATE JOBS SET GRADE_LEVEL = 'ME' WHERE JOB_TITLE = 'BBB';
UPDATE JOBS SET GRADE_LEVEL = 'SI' WHERE JOB_TITLE = 'AAA';
SELECT * FROM JOBS;
SELECT * FROM JOB_GRADES;
